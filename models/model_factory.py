...
def build_model(cfg):
	...
	if cfg.model.name == "muse_vqgan":
    
		# ViTVQGAN
		
		vq = VQVAE("/home/pranoy/code/scratch_experiments/models/vae/ckpt/model.yaml", "/home/pranoy/code/scratch_experiments/models/vae/ckpt/last.ckpt")
